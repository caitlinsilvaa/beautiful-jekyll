...
![Installation steps](/beautiful-jekyll/assets/img/install-steps.gif)
...
<style>
.gs-section-01 h3 { color: #B8003B; }
.gs-section-01 p  { font-size: 20px; }

.gs-section-02 h3 { color: #FC3468; }
.gs-section-02 p  { font-size: 18px; }

.gs-section-03 h3 { color: #7D2049; }
